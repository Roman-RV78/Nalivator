...
#define ADC_U_COEFF_LOW 0.003 // нижнее значение коэффициента, для АКБ на 4.2 вольта, под другой вольтаж нужно править исходя из ADC_U_COEFF(начального коэффициента)
#define ADC_U_COEFF_HIGH 0.006 // верхнее значение коэффициента, для АКБ на 4.2 вольта, под другой вольтаж нужно править исходя из ADC_U_COEFF(начального коэффициента)
