...
//#define STARTING_POS_SERVO_GLASS1 // раскомментировать, если нужна начальная позиция серво в первой рюмке, а не в нуле
...
// =========== ПИНЫ ===========
#define SERVO_PIN 9   // серво
#define PUMP_POWER 12 // помпа
#define LED_PIN 5  // пин ленты
#ifdef BAT_MONITOR_ON
  #define BAT_PIN A9 // пин замера напряжения акб
#endif
#define BUSY_PIN 10  // пин готовности DF плеера
const uint8_t SW_pins[] = {A0, A1, A2, A3, A7, A8};  //  пины концевиков
// ПИНЫ ЭНКОДЕРА
#define CLK  7
#define DT  6
...
#ifdef LED_TOWER
#define LED_PIN2 11  // пин второй ленты
...
LCD_1602_RUS lcd(0x27, 16, 2); //Адрес дисплея обычно 0x27 или 0x3F, подключение экрана 20-SDA-зеленый, 21-SCL-желтый
DFPlayerMini_Fast myMP3;

#ifdef BUTTON_TOWER
#define BUT_TOWER_PIN 22 // пин кнопки на башне
bool stateBut = false;
#endif
